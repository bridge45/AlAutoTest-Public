...
# 进入容器
docker-compose exec armv7-dev bash
...
| 工具 | 用途 | 速度 | 适用场景 |
|------|------|------|----------|
| `docker-compose` | ARMv7 Docker开发 | ⚡⚡⚡ | 跨平台开发、隔离环境 |
| `./dev.sh` | 本地开发 | ⚡⚡⚡ | 日常开发、调试 |
| `./build.sh` | 简单构建 | ⚡⚡ | 快速构建 |
| `make` | 传统构建 | ⚡ | 兼容性构建 |
...
| 操作 | 本地开发 | ARMv7 Docker | GitHub Actions |
|------|----------|--------------|----------------|
| 编译时间 | 0.1-0.5秒 | 0.2-1秒 | 30-60秒 |
| 测试时间 | 0.1-1秒 | 0.2-2秒 | 5-10秒 |
| 调试便利性 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐ |
| 发布便利性 | ⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| 环境隔离 | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
